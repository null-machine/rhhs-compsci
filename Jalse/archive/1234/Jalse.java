...
public class Jalse extends JFrame {
  ...
  private double trackLength = 200; // short 100, medium 100, long 150, xtra long 200
  private double trackWidth = 4; // easy 6, imposs 3
  private int pivotCount = 12; // irrelevant?
