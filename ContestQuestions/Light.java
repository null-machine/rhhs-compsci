...
public class Light
{
	...
	public Light(boolean o, boolean b, String c)
	{
            ...
            if(c.toLowerCase().equals("red")||c.toLowerCase().equals("green")||c.toLowerCase().equals("blue")) color = c.toLowerCase();
            else color = "white";
	}
	...
	{
            String str = "";
            if(on) str = str + "on" + color + "\t";
            else str = str + "off" + color + "\t";
            if(burntOut) str = str + "burnt out";
            else str = str + "not burnt out";
            return str;
	}
