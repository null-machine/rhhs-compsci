...
public class GameLauncher extends Canvas implements Runnable {
  ...
  // call in boss class
    ...
    //AUTHOR:SUNNY
    /* increase another room
     * @param tx transport player to x location on new room
     * @param ty transport player to y location on new room
     * 
   ...
   */
    ...
    //AUTHOR:SUNNY
    /* renders all the bitmaps onto the screen
   */
    private void render() {
    ...
    /* updates all the variables in our program to be rendered
   */
    private void tick() {
        level.tick();
        UI.tick(floor, input);
